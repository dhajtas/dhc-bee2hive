...
extern complex_t Bfly_buffer[FFT_N];
extern int16_t Signal[2][FFT_N];
//extern volatile complex_t Bfly_buffer[FFT_N];
//extern volatile int16_t Signal[2][FFT_N];
...
int16_t FFT_Fmuls_f (int16_t, int16_t);
